...
codex-high 适合在此阶段的原因：
- 拥有足够推理能力
- 但不会像 max-high 那样扫描整个系统造成额外成本
- 能快速产出“改哪些地方”的列表

---

### 11.2 开发阶段（使用：codex-medium）
实际改代码、重构、补全、写 SQL 时，使用 **codex-medium**：

- medium 速度快、成本低
- 适合频繁迭代与试验
- 写代码与补全能力最强
- ✓ 遵循 AI_GUIDELINES.md 中的编码规范
- ✓ 自动生成合规的注释
- ✓ 遵守你的包结构、工具类和代码风格规则

---

### 11.3 自测与需求闭环检查（使用：codex-high）
...
codex-high 在此阶段的优势：
- 能从“高级工程师 + 产品经理”的角度双视角验证
- 能发现 medium 无法察觉的逻辑缺陷
- 成本远低于 max-high

---

### 11.4 上线前系统级审查（使用：codex max-high）
...
codex max-high 的优势：
- 深度推理能力最强
- 能像“资深架构师 + 产品经理 + 测试总监”一样审查系统
- 能发现 cross-module 的隐蔽逻辑缺陷
- 能找到普通 Codex 找不到的“隐藏问题”
